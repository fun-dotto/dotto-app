...
class CancelledClassesApi {
  ...
  const CancelledClassesApi(this._dio, this._serializers);
  ...
  Future<Response<CancelledClassesV1List200Response>> cancelledClassesV1List({
    ...
    final _path = r'/v1/cancelledClasses';
    ...
    CancelledClassesV1List200Response? _responseData;
    ...
    return Response<CancelledClassesV1List200Response>(
      data: _responseData,
