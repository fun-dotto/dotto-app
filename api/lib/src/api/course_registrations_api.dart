...
class CourseRegistrationsApi {
  ...
  const CourseRegistrationsApi(this._dio, this._serializers);

  /// courseRegistrationsV1Create
  /// 履修情報を作成する
  ///
  /// Parameters:
  /// * [courseRegistrationRequest] - 作成する履修情報の情報
  ...
  Future<Response<CourseRegistrationsV1Create201Response>> courseRegistrationsV1Create({ 
    ...
    CourseRegistrationsV1Create201Response? _responseData;
    ...
    return Response<CourseRegistrationsV1Create201Response>(
      data: _responseData,
  ...
  Future<Response<CourseRegistrationsV1List200Response>> courseRegistrationsV1List({ 
    ...
    CourseRegistrationsV1List200Response? _responseData;
    ...
    return Response<CourseRegistrationsV1List200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
