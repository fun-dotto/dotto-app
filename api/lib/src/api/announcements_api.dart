...
class AnnouncementsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Announcement>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Announcement>>> announcementsV0List({ 
    ...
    BuiltList<Announcement>? _responseData;
    ...
    return Response<BuiltList<Announcement>>(
      data: _responseData,
  ...
  Future<Response<AnnouncementsV1List200Response>> announcementsV1List({ 
    ...
    AnnouncementsV1List200Response? _responseData;
    ...
    return Response<AnnouncementsV1List200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
