...
enum TimetableSemester {
  ...
  List<Semester> get semesters => switch (this) {
    TimetableSemester.spring => [Semester.h1, Semester.allYear, Semester.q1, Semester.q2, Semester.summerIntensive],
    TimetableSemester.fall => [Semester.h2, Semester.allYear, Semester.q3, Semester.q4, Semester.winterIntensive],
  };
