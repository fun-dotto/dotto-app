...
final class DomainError implements Exception {
  ...
  factory DomainError._fromDioException({required DioException e, StackTrace? stackTrace}) {
    switch (e.type) {
      ...
      case DioExceptionType.badResponse:
        ...
        if (statusCode != null) {
          if (statusCode == 401) return DomainError.unauthorized(e: e, stackTrace: stackTrace);
          if (statusCode == 403) return DomainError.forbidden(e: e, stackTrace: stackTrace);
          if (statusCode == 404) return DomainError.notFound(e: e, stackTrace: stackTrace);
          if (statusCode >= 500) return DomainError.server(e: e, stackTrace: stackTrace);
        }
  ...
  factory DomainError._fromFirebaseException({required FirebaseException e, StackTrace? stackTrace}) {
    switch (e.code) {
      case 'unavailable':
